...
const config: QueueRuntimeConfig = { redisUrl: redisUrl ?? "redis://127.0.0.1:6379", prefix, concurrency: 2, maxAttempts: 2, backoffMs: 10, jobTimeoutMs: 1000, smtpTimeouts: { connectionTimeoutMs: 100, greetingTimeoutMs: 100, socketTimeoutMs: 200 }, leaseMs: 31_000, shutdownTimeoutMs: 2_000, schedulerEnabled: false };
