...
ADD COLUMN     "two_factor_enabled_at" TIMESTAMPTZ(6),
ADD COLUMN     "two_factor_recovery_code_hashes" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateIndex
CREATE INDEX "two_factor_challenges_user_id_used_at_idx" ON "two_factor_challenges"("user_id", "used_at");
