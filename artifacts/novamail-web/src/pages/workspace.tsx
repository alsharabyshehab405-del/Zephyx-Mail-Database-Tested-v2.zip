...
export default function Workspace() {
  ...
  const reasonLabel = (reason: string) => {
    const keys: Record<string, string> = { unread: "workspace.reasonUnread", starred: "workspace.reasonStarred", primary: "workspace.reasonPrimary", deadline_or_action: "workspace.reasonDeadlineOrAction", work_context: "workspace.reasonWorkContext", label: "workspace.reasonLabel" };
